odoo.define("ts_task_timer.time_track", function (require) {
    "use strict";
...
odoo.define("ts_task_timer.TaskTimerTemplate", function (require) {
    var core = require("web.core");
    ...
    var TimerMenu = Widget.extend({
        ...
        _start_timer: function (e) {
            ...
            this.do_action({
                ...
                view_mode: "form",
                views: [[false, "form"]],
                res_model: "ts.start.timesheet",
                target: "new",
                context: {
                    form_view_ref: "ts_task_timer.start_timesheet_form",
                },
            });
        },
...
//
//odoo.define("ts_task_timer.QuicklyTaskCreateTemplate", function (require) {
//    var core = require("web.core");
//    var Widget = require("web.Widget");
//    var SystrayMenu = require("web.SystrayMenu");
//
...
//                target: "new",
//                context: {
//                    form_view_ref: "ts_task_timer.QuicklyTaskCreateTemplate",
//                },
//            });
//        },
//
